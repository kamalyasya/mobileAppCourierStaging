...
Feature: Voucher
        ...
        @Voucher-2
        Scenario: Memastikan voucher tetap tampil ketika order tolakan sebagian by super
            ...
            #   And I click lanjut
             ...
             When user click specific order
              ...
              And user click tolakan dari "Super"
             ...
             When user click spesific order
              ...
              And user click lihat selengkapnya
              And user shown nominal voucher
             Then user successfully memastikan voucher tetap tampil ketika order tolakan sebagian by super
            ...
            #   And user click import CSV /
            #   And user click area file import /
            #   And user choose file import csv /
            #   And user click open
            #   And user click Import
            #   And user successfully import csv setoran (same nominal) /
            #   And user check result import csv /
