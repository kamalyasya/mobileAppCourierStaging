...
Feature: Voucher
        ...
        @Voucher-6
        Scenario: Memastikan voucher terlepas ketika order tolakan semua by customer
            ...
            #   And I click lanjut
             ...
             When user click spesific order
              ...
              And user click lihat selengkapnya
              And user not shown nominal voucher
             Then user successfully memastikan voucher terlepas ketika order tolakan semua by customer
