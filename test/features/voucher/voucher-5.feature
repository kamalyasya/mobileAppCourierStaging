...
Feature: Voucher
        ...
        @Voucher-5
        Scenario: Memastikan voucher terlepas ketika order tolakan semua by super
            ...
            #   And I click lanjut
             ...
             When user click specific order
              ...
              And user choose status penerimaan "Ditolak Semua"
             ...
             When user click spesific order
              ...
              And user click lihat selengkapnya
              And user not shown nominal voucher
             Then user successfully memastikan voucher terlepas ketika order tolakan semua by super
