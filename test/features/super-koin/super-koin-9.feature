...
Feature: Super Koin
        ...
        @SuperKoin-9
        Scenario: Memastikan Ketika ada tolakan Sebagian Customer seluruh Product Rokok, Bundle, flashsale, tidak ada penyesuaian Super koin (Order Product Rokok, Flashsale, Bundle dan Non Rokok)
            ...
            #   And I click lanjut
             ...
             When user click specific order
              ...
              And user click tolakan dari "Customer" for "Third" SKU
              And user input qty tolakan with value 4 for "Third" SKU
              And user click tolakan dari "Customer" for "Forth" SKU
